          ...
          {true && (
            <div className="w-full h-full mx-auto">
              <div className="w-full flex items-center justify-between">
                ...
                <Button label="Generate New Certificate" />
              </div>
              ...
              <div className="mt-8 w-full flex flex-wrap gap-5 items-center justify-between">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div className="px-4 py-6 flex flex-col justify-between gap-5 w-[280px] h-[330px] rounded-md border-2 border-slate-200/40">
