  ...
  return (
    <div className="w-full h-auto font-dm-sans">
      ...
      >
        ...
        <section className="mt-32 w-[80%] flex gap-5 items-start justify-center mx-auto">
        ...
        <section className="mt-32 w-full flex gap-5 items-start justify-start mx-auto mb-10">
          {Array.from({ length: 4 }, (_, index) => (
            <div
              className="w-1/4 px-3 py-5 flex flex-col items-center justify-center gap-1 bg-[#3E66DF] rounded-xl"
              key={index}
            >
              <img
                className="w-[50%]"
        ...
        <footer className="mt-32 px-32 py-14 w-full mx-auto mb-10 bg-gradient-to-r from-[#653FFF] to-[#1C2792]">
          <div className="w-full flex justify-around items-start gap-2">
            ...
            <div className="w-[35%] flex flex-col justify-center gap-8">
            ...
            <div className="w-1/4 flex flex-col items-start justify-center gap-5">
              <h3 className="text-xl font-bold text-white">Subscribe</h3>
              <Input placeholder="Get product updates" className="bg-white" />
            </div>
          </div>
          <hr className="mt-16 mb-5 border-none bg-[#D8DCDF]/50 h-[2px]" />
          <div className="mt-10 w-full flex justify-around items-center gap-2">
